...
from TTMDNPUs.config.schemas import OutputTSMixer, OutputTSPatchMixer, OutputTSFeatureMixer, OutputTSChannelMixer
from TTMDNPUs.utils.mlp import TTMMLP
from TTMDNPUs.utils.gated_attention import TTMGatedAttention
from TTMDNPUs.utils.normalize import TTMNormalize
import torch
...
class TSMixer(nn.Module):
  ...
  def forward(self, hidden: torch.Tensor):
    ...
    elif self.mode == 'combine_channel':
      hidden = self.channel_feature_combination(hidden).channel_combinated_hidden
