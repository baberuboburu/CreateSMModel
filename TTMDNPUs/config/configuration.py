...
class TTMConfiguration(PretrainedConfig):
  def __init__(
    self,
    ...
    **kwargs,
    ...
    # backend
    self.backend = torch.device("cuda" if torch.cuda.is_available() else "mps" if torch.backends.mps.is_available() else "cpu")
