...
ORIGINAL_TTM_MODEL_DIR = os.path.join(MODELS_DIR, "original_ttm")
ORIGINAL_TTM_MODEL_PRETRAINED_DIR = os.path.join(TTM_MODEL_DIR, "pretrained")
TTM_MODEL_FEWSHOT_DIR = os.path.join(TTM_MODEL_DIR, "fewshots")
...
PREDICTIONS_ORIGINAL_TTM_DIR = os.path.join(PREDICTIONS_DIR, "original_ttm")
